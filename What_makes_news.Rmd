...
# DR
p = ggplot(data = Sum_DR, aes(x = reorder(section, avg_sum), y = avg_sum))
p = p + geom_bar(stat = "identity", position = "dodge", width = 0.8, fill = "darkgrey") + coord_flip() +
  labs(title = "DR",x = "Section", y = "Average number of likes, \n shares and comments per article")
p = p + theme(panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(),
              panel.background = element_blank(),
              axis.line = element_line(colour = "black"),
...
# Politiken
p = ggplot(data = Sum_Politiken, aes(x = reorder(section, avg_sum), y = avg_sum))
p = p + geom_bar(stat = "identity", position = "dodge", width = 0.8, fill = "darkgrey") + coord_flip() +
  labs(title = "Politiken",x = "Section", y = "Average number of likes, \n shares and comments per article")
p = p + theme(panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(),
              panel.background = element_blank(),
              axis.line = element_line(colour = "black"),
