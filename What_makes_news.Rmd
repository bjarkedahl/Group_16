...
If that is the case, we are in a situation where the more knowledge the media gets about what people like - via. for example, Facebook Insight-service - the more they are contributing to creating an "enclosed" system.
